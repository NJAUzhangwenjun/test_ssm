            ...
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li>
                                <a href="/syslog/findAll.do?page=1&size=${page.size}" aria-label="Previous">首页</a>
                            </li>

                            <c:if test="${page.hasPrevious()}">
                                <li><a href="/syslog/findAll.do?page=${page.current-1}&size=${page.size}">上一页</a>
                                </li>
                                <li>
                                    <a href="/syslog/findAll.do?page=${page.current-1}&size=${page.size}">${page.current-1}</a>
                                </li>
                            </c:if>
                            <li><a class="btn bg-olive"
                                   href="/syslog/findAll.do?page=${page.current}&size=${page.size}">${page.current}</a>
                            </li>
                            <c:if test="${page.hasNext()}">
                                <li>
                                    <a href="/syslog/findAll.do?page=${page.current+1}&size=${page.size}">${page.current+1}</a>
                                </li>
                                <li><a href="/syslog/findAll.do?page=${page.current+1}&size=${page.size}">下一页</a>
                                </li>
                            </c:if>
                            <li>
                                <a href="/syslog/findAll.do?page=${pages}&size=${page.size}"
...
<script>
    ...
    function changePageSize() {
        ...
        //向服务器发送请求，改变没页显示条数
        location.href = "/syslog/findAll.do?page=${page.current}&size="
            + pageSize;
    }
