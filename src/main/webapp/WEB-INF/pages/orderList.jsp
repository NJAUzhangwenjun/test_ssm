            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList"
                            ...
                            <c:forEach items="${page.records}" var="orders">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button type="button" class="btn bg-olive btn-xs"
                                                onclick="location.href='/orders/findById.do?id=${orders.id}'">
                                            详情
                                        </button>
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li>
                                <a href="/orders/findAllPage.do?page=1&size=${page.size}" aria-label="Previous">首页</a>
                            </li>

                            <c:if test="${page.hasPrevious()}">
                                <li><a href="/orders/findAllPage.do?page=${page.current-1}&size=${page.size}">上一页</a>
                                </li>
                                <li>
                                    <a href="/orders/findAllPage.do?page=${page.current-1}&size=${page.size}">${page.current-1}</a>
                                </li>
                            </c:if>
                            <li><a class="btn bg-olive"
                                   href="/orders/findAllPage.do?page=${page.current}&size=${page.size}">${page.current}</a>
                            </li>
                            <c:if test="${page.hasNext()}">
                                <li>
                                    <a href="/orders/findAllPage.do?page=${page.current+1}&size=${page.size}">${page.current+1}</a>
                                </li>
                                <li><a href="/orders/findAllPage.do?page=${page.current+1}&size=${page.size}">下一页</a>
                                </li>
                            </c:if>
                            <li>
                                <a href="/orders/findAllPage.do?page=${pages}&size=${page.size}"
...
<script>
    ...
    function changePageSize() {
        ...
        //向服务器发送请求，改变没页显示条数
        location.href = "/orders/findAllPage.do?page=${page.current}&size="
            + pageSize;
    }
