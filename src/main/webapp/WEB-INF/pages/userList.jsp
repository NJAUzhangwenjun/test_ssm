            ...
            <div class="box box-primary">
                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建"
                                            onclick="location.href='/users/toUserAdd.do'">
                            ...
                            <c:forEach items="${userList}" var="user">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="/users/findById.do?id=${user.id}" class="btn bg-olive btn-xs">详情</a>
                                        <a href="/users/findUserByIdAndAllRole.do?id=${user.id}"
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li>
                                <a href="/users/findAll.do?page=1&size=${page.size}" aria-label="Previous">首页</a>
                            </li>

                            <c:if test="${page.hasPrevious()}">
                                <li><a href="/users/findAll.do?page=${page.current-1}&size=${page.size}">上一页</a>
                                </li>
                                <li>
                                    <a href="/users/findAll.do?page=${page.current-1}&size=${page.size}">${page.current-1}</a>
                                </li>
                            </c:if>
                            <li><a class="btn bg-olive"
                                   href="/users/findAll.do?page=${page.current}&size=${page.size}">${page.current}</a>
                            </li>
                            <c:if test="${page.hasNext()}">
                                <li>
                                    <a href="/users/findAll.do?page=${page.current+1}&size=${page.size}">${page.current+1}</a>
                                </li>
                                <li><a href="/users/findAll.do?page=${page.current+1}&size=${page.size}">下一页</a>
                                </li>
                            </c:if>
                            <li>
                                <a href="/users/findAll.do?page=${pages}&size=${page.size}"
...
<script>
    ...
    function changePageSize() {
        ...
        //向服务器发送请求，改变没页显示条数
        location.href = "/users/findAll.do?page=${page.current}&size="
            + pageSize;
    }
